::debloat wip:: w/o bt, nfc, touchless. no google signin e.g. maps or playstore. w/ wifi, cell, text, cam, location..
::some packages from factory have been renamed a little I don't know why but anyway this is what I found on this 5G android 13 samsung A13
...
adb shell "pm disable-user --user 0 com.rsupport.rs.activity.rsupport.aas2"
